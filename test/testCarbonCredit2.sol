...
contract ERC3475 is IERC3475 {
    ...
    constructor() {
        ...
        _classes[1]._values["symbol"].stringValue = "ACR566";
        ...
        _classes[1]._values["projectWebSite"].stringValue = "";
        ...
        _classes[1]._values["projectDeveloperLogo"].stringValue = "";
        ...
        _classes[2]._values["symbol"].stringValue = "ACR566";
        _classes[2]._values["projectID"].stringValue = "ACR566"; 
        ...
        _classes[2]._values["description"].stringValue = "Capture mine methane to reduce GHG emission";  
        _classes[2]._values["projectName"].stringValue = "Bluesource - 100 Mile Wilderness Improved Forest Management Project";  
        _classes[2]._values["projectType"].stringValue = "Forest Carbon";
        _classes[2]._values["projectProtocol"].stringValue = "Improved Forest Management (IFM) on Non-Federal U.S. Forestlands";
        _classes[2]._values["projectWebSite"].stringValue = "";
        ...
        _classes[2]._values["projectDeveloperLogo"].stringValue = "";
