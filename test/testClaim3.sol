...
contract ERC3475 is IERC3475 {
    ...
    constructor() {
        ...
        _classes[1]._values["symbol"].stringValue = "Celcius BTC Claim";
        ...
        _classes[1]._values["description"].stringValue = "holder of this token owns the claim for the crypto asset in Celcius Network LLC. Their claim may be redeemed aftre the liquidation process";
        _classes[1]._values["issuerName"].stringValue = "Celcius";
        _classes[1]._values["issuerType"].stringValue = "LLC";
        _classes[1]._values["issuerJurisdiction"].stringValue = "US";
        _classes[1]._values["issuerRegistrationAddress"].stringValue = "50 Harrison Street, Suite 209F Hoboken, NJ 07030";
        _classes[1]._values["issuerURL"].stringValue = "https://celsius.network/";
        _classes[1]._values["issuerLogo"].stringValue = "https://seeklogo.com/images/C/celsius-cel-logo-AFE74F461C-seeklogo.com.png";
        ...
        _classes[1]._values["liquidatorName"].stringValue = "Celcius";
        _classes[1]._values["liquidatorType"].stringValue = "LLC";
        _classes[1]._values["liquidatorJurisdiction"].stringValue = "US";
        _classes[1]._values["liquidatorRegistrationAddress"].stringValue = "50 Harrison Street, Suite 209F Hoboken, NJ 07030";
        _classes[1]._values["liquidatorURL"].stringValue = "https://celsius.network/";
        _classes[1]._values["liquidatorLogo"].stringValue = "https://seeklogo.com/images/C/celsius-cel-logo-AFE74F461C-seeklogo.com.png";
        ...
        _classes[1]._values["intendedDate"].stringValue = "1675962000";  
        ...
        _classes[2]._values["symbol"].stringValue = "Celcius ETH Claim";
        ...
        _classes[2]._values["description"].stringValue = "holder of this token owns the claim for the crypto asset in Celcius Network LLC. Their claim may be redeemed aftre the liquidation process";
        _classes[2]._values["issuerName"].stringValue = "Celcius";
        _classes[2]._values["issuerType"].stringValue = "LLC";
        _classes[2]._values["issuerJurisdiction"].stringValue = "US";
        _classes[2]._values["issuerRegistrationAddress"].stringValue = "50 Harrison Street, Suite 209F Hoboken, NJ 07030";
        _classes[2]._values["issuerURL"].stringValue = "https://celsius.network/";
        _classes[2]._values["issuerLogo"].stringValue = "https://seeklogo.com/images/C/celsius-cel-logo-AFE74F461C-seeklogo.com.png";
        _classes[2]._values["issuerRegistrationNumber"].stringValue = "US-000000000000";
        _classes[2]._values["issuerDocURL"].stringArrayValue = [
            "https://pacer-documents.s3.amazonaws.com/115/312902/126122257414.pdf"
        ];  
        _classes[2]._values["liquidatorName"].stringValue = "Celcius";
        _classes[2]._values["liquidatorType"].stringValue = "LLC";
        _classes[2]._values["liquidatorJurisdiction"].stringValue = "US";
        _classes[2]._values["liquidatorRegistrationAddress"].stringValue = "50 Harrison Street, Suite 209F Hoboken, NJ 07030";
        _classes[2]._values["liquidatorURL"].stringValue = "https://celsius.network/";
        _classes[2]._values["liquidatorLogo"].stringValue = "https://seeklogo.com/images/C/celsius-cel-logo-AFE74F461C-seeklogo.com.png";
        ...
        _classes[2]._values["intendedDate"].stringValue = "1675962000";  
        ...
        _classes[3]._values["symbol"].stringValue = "Celcius USDC Claim";
        ...
        _classes[3]._values["description"].stringValue = "holder of this token owns the claim for the crypto asset in Celcius Network LLC. Their claim may be redeemed aftre the liquidation process";
        _classes[3]._values["issuerName"].stringValue = "Celcius";
        _classes[3]._values["issuerType"].stringValue = "LLC";
        _classes[3]._values["issuerJurisdiction"].stringValue = "US";
        _classes[3]._values["issuerRegistrationAddress"].stringValue = "50 Harrison Street, Suite 209F Hoboken, NJ 07030";
        _classes[3]._values["issuerURL"].stringValue = "https://celsius.network/";
        _classes[3]._values["issuerLogo"].stringValue = "https://seeklogo.com/images/C/celsius-cel-logo-AFE74F461C-seeklogo.com.png";
        _classes[3]._values["issuerRegistrationNumber"].stringValue = "US-000000000000";
        _classes[3]._values["issuerDocURL"].stringArrayValue = [
            "https://pacer-documents.s3.amazonaws.com/115/312902/126122257414.pdf"
        ];  
        _classes[3]._values["liquidatorName"].stringValue = "Celcius";
        _classes[3]._values["liquidatorType"].stringValue = "LLC";
        _classes[3]._values["liquidatorJurisdiction"].stringValue = "US";
        _classes[3]._values["liquidatorRegistrationAddress"].stringValue = "50 Harrison Street, Suite 209F Hoboken, NJ 07030";
        _classes[3]._values["liquidatorURL"].stringValue = "https://celsius.network/";
        _classes[3]._values["liquidatorLogo"].stringValue = "https://seeklogo.com/images/C/celsius-cel-logo-AFE74F461C-seeklogo.com.png";
        ...
        _classes[3]._values["intendedDate"].stringValue = "1675962000";  
