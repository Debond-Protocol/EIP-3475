...
* @return the JSON metadata of the class properties for the frontend to interpret them. — e.g. `[title, type, description]`.
*/
...
* @returns the JSON metadata of the nonce values for the frontend to interpret them. — e.g. `[title, type, description]`.
*/
...
The `amount` is the amount of the bond for which the spender is approved.
