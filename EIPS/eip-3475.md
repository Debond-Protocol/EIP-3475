...
author: Yu LIU (@yuliu-debond), Cedric Ngakam (@drikssy), Dhruv Malik (@GrandGarcon), Samuel Gwlanold (@Edoumou), Toufic Batrice (@toufic0710)
...
***Note that the ERC 3475 interface is also compatible with ERC-20 and [ERC-721](https://eips.ethereum.org/EIPS/eip-721) interface .*** But the creation of a separated bank contract is recommended for reading and future upgrade needs and .
...
[ERC-3475 Reference Implementation](https://github.com/Debond-Protocol/EIP-3475/blob/master/contracts/ERC3475.sol)

**This demonstration show only a simple application of ERC3475 Multiple Callable Bonds Standard. Developers can build much sophisticated logic with this interface. No function used in the example serves as a guide-line.
