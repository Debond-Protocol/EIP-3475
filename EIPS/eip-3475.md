...
author: Yu LIU (@yuliu-debond), Yu LIU <info@debond.org>, Cedric Ngakam [@drikssy](@drikssy), Dhruv Malik [@GrandGarcon](@GrandGarcon), Samuel Gwlanold [@Edoumou](@Edoumou), Toufic Batrice [@toufic0710](@toufic0710)
...
Returns a list of uint256 parameters of a bond class. — e.g. `["1615584000",(2rd uint256)...]`.*** Every bond contract can have their own list.*
...
https://github.com/Debond-Protocol/EIP-3475/blob/master/contracts/ERC3475.sol
