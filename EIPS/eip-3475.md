...
**TransferAllowenceFrom**

`transferAllowenceFrom(address _from, address _to, TRANSACTION[] calldata _transaction)` allows the transfer of allocated bond balances from an address to another.
...
@dev TransferAllowenceFrom MUST have the allowanceFrom check if "_opretor" address is allowed to transfer from "_from" address to "_to" address.

e.g.

``` Solidity
 TransferAllowenceFrom(0x2d03B6C79B75eE7aB35298878D05fe36DC1fE8Ef, 0x82a55a613429Aeb3D01fbE6841bE1AcA4fFD5b2B, [{ 1, 42, 500000000}]);
```
...
@dev the function MUST be called by the msg.sender who is holder of the bonds

e.g.

```Solidity
setApprovalFor(0x82a55a613429Aeb3D01fbE6841bE1AcA4fFD5b2B, true);
```
...
means that the 5000 bonds of class 1, nonce 14 owned by address 0x492Af743654549b12b1B807a9E0e8F397E44236E are being redeemed by 0x2d03B6C79B75eE7aB35298878D05fe36DC1fE8Ef.
...
ex: ApprovalFor(0x2d03B6C79B75eE7aB35298878D05fe36DC1fE8Ef, 0x492Af743654549b12b1B807a9E0e8F397E44236E);
...
**This demonstration shows only basic ERC-3475 bonds reference implementation. Developers can build much sophisticated logic (like fixed / floating rate bond) with this interface, the Debond-ERC3475 gives an reference example**
