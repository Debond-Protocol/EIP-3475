...
contract TestBank{
    ...
    function setContract(uint256 class, address token_contract_address,address bond_contract_address) public returns (bool) {
        ...
        // needs sanity check regarding the nature of the token address
        //require(token_contract_address != Address(0) && bond_contract_address != Address(0) || token_contract_address = isContract() )
        // 
